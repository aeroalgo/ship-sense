...
├── SKILL.md                      # Core skill (lazy-loaded)
└── references/
    ├── FULL-GUIDE.md             # Full compiled document (all references expanded)
...
```
Do not add `AGENTS.md` here — Cursor always-loads that filename into every chat.
