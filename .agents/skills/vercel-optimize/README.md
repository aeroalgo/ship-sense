...
Manual install: copy `skills/vercel-optimize` into `.agents/skills/vercel-optimize` and follow `SKILL.md` when optimizing. Do not add skill-local `AGENTS.md` — Cursor always-loads that filename.
