...
- [ ] **s11-quality-engine.md:**
  ...
  - `**CREATIVE:** CR-COL-04 → ...` → добавить ссылку `[creative-collector-quality-mapping.md](../../creative/creative-collector-quality-mapping.md)`
...
- **Files:** `memory-bank/back/creative/creative-collector-quality-mapping.md`
