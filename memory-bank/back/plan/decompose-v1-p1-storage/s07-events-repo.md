...
**Creative:** [CR-STO-04 event dual-mode schema](../../creative/creative-event-dual-mode-schema.md)
...
## Блокеры / CREATIVE
CR-STO-04 dual-mode — [frozen core + JSONB envelope, Q4=A/B models](../../creative/creative-event-dual-mode-schema.md); reconstructed flag + params JSONB.
