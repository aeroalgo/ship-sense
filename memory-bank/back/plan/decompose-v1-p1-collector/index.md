...
|----|------|----------|--------|
| CR-COL-04 | s11 | `memory-bank/back/creative/creative-collector-quality-mapping.md` | **done** (2026-07-27) ✅ |
| CR-COL-02 | s08 | `memory-bank/back/creative/creative-collector-modbus-poll-groups.md` | **done** (2026-07-26) ✅ |
| CR-COL-01 | s04 | `memory-bank/back/creative/creative-collector-isolation.md` | **done** (2026-07-26) |
| CR-COL-03 | s15 (+ влияет s16–s18) | [`creative-collector-emulator-fidelity.md`](../../creative/creative-collector-emulator-fidelity.md) | **done (2026-07-27) ✅** |
...
- **QA artifact:** `memory-bank/back/qa/qa-20260727-v1-p1-collector.md`.
...
- **load_now:** `memory-bank/back/qa/qa-20260727-v1-p1-collector.md`; затем s26 implement artifact и изменённые runtime-файлы.
...
- [ ] Full BACK QA выполнен.
- [ ] Compose smoke green.
- [ ] Writer frames подтверждены.
- [ ] `Write refused` отсутствует.
- [ ] T-001 закрыт после QA verdict.
