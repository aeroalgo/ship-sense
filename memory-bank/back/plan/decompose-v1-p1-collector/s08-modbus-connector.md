...
- **CREATIVE:** CR-COL-02 → [creative-collector-modbus-poll-groups.md](../../creative/creative-collector-modbus-poll-groups.md) ✅ **closed**
...
- **Creative:** [CR-COL-02](../../creative/creative-collector-modbus-poll-groups.md) — алгоритм группировки (max_gap, max_regs, min hz), дизайн ModbusTcpConnector (poll loop per group), diag mode (MODBUS_DEBUG).
- **Рекомендации:**
