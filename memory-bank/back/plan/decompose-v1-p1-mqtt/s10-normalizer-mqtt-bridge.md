...
- **Creative:** [CR-COL-05 / creative-collector-mqtt-contract.md](../../creative/creative-collector-mqtt-contract.md) — `skip_event_detector: true` for mqtt tags, Event passthrough, idempotency dedup
...
1. ~~**BLOCKED** partial until s05 Event shape finalized in CR-COL-05~~ — **unblocked:** Event shape + skip_event_detector в [creative](../../creative/creative-collector-mqtt-contract.md).
