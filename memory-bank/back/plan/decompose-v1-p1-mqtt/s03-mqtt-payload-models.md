...
- **Creative:** [CR-COL-05 / creative-collector-mqtt-contract.md](../../creative/creative-collector-mqtt-contract.md) — topic taxonomy hybrid, payload schema v1.0, `@type` + topic validate
...
1. ~~**BLOCKED** до CR-COL-05~~ — **unblocked:** финальные имена полей, `@type` discriminator, `source_ts` — см. [creative-collector-mqtt-contract.md](../../creative/creative-collector-mqtt-contract.md) §3.
