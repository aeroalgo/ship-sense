...
| # | Путь | Статус |
|---|------|--------|
| 1 | `memory-bank/front/creative/CR-UI-05-post-density.md` (этот файл) | done |
...
- **Files:** `memory-bank/front/creative/CR-UI-05-post-density.md`; `frontend/src/lib/theme/post-density-spec.ts`; `frontend/src/styles/tokens/**`; `OverviewGroupCard.tsx`; `MoSection.tsx`
