...
| # | Путь | Статус |
|---|------|--------|
| 1 | `memory-bank/front/creative/CR-UI-01-tokens.md` (этот файл) | done |
...
- **Files:** `memory-bank/front/creative/CR-UI-01-tokens.md`; `frontend/src/styles/tokens/**`; `frontend/src/lib/theme/types.ts`; `frontend/src/lib/theme/switcher-spec.ts`
