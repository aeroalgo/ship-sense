...
| # | Путь | Статус |
|---|------|--------|
| 1 | `memory-bank/front/creative/v1-p1-screens/CR-UI-03-alarm-grammar.md` (этот файл) | done |
...
- **Files:** `memory-bank/front/creative/v1-p1-screens/CR-UI-03-alarm-grammar.md`; `frontend/public/ds/lamps/*`; `frontend/src/lib/ds/lamp-grammar-spec.ts`
