...
|----|------|----------|--------|
| **CR-COL-05** ✅ | s03, s04, s05, s06, s10 | [creative-collector-mqtt-contract.md](../../creative/v1-p1-mqtt/creative-collector-mqtt-contract.md) | **closed** 2026-07-27 |
...
- [x] s03 — payload pydantic models (Analog/Discrete/Event/EGT)
