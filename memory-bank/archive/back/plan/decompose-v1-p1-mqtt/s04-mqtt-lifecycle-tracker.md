...
- **Creative:** [CR-COL-05 / creative-collector-mqtt-contract.md](../../creative/v1-p1-mqtt/creative-collector-mqtt-contract.md) — lifecycle mapping tables, silent seed, idempotency_key, native passthrough
