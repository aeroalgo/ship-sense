...
3. Комментарий: dual-mode до Q4 (CR-STO-04) — **closed**, решение: [frozen core + JSONB envelope](../../creative/v1-p1-storage/creative-event-dual-mode-schema.md).
...
## Блокеры / CREATIVE
CR-STO-04 (event schema dual-mode) — [closed: frozen core + params JSONB](../../creative/v1-p1-storage/creative-event-dual-mode-schema.md).
