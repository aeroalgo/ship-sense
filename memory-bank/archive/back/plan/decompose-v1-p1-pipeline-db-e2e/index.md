...
| **s05** | [s05-l1-mqtt-lifecycle-events.md](s05-l1-mqtt-lifecycle-events.md)<br>• `tests/pipeline/test_mqtt_pipeline_db.py` (дополнить) | [s05](../../implement/implement-v1-p1-pipeline-db-e2e/s05-l1-mqtt-lifecycle-events.md) | no | yes | AC-PIPE-04 | BACK IMPLEMENT | completed |
| **s06** | [s06-l1-modbus-pipeline-samples.md](s06-l1-modbus-pipeline-samples.md)<br>• `tests/pipeline/test_modbus_pipeline_db.py` | [s06](../../implement/implement-v1-p1-pipeline-db-e2e/s06-l1-modbus-pipeline-samples.md) | no | yes | AC-PIPE-05 | BACK IMPLEMENT | completed |
| **s07** | [s07-compose-smoke-pipeline-db.md](s07-compose-smoke-pipeline-db.md)<br>• `scripts/smoke-pipeline-db.sh`<br>• optional `tests/pipeline/test_compose_db_smoke.py`<br>• `docker-compose.yml` (если flaky) | [s07](../../implement/implement-v1-p1-pipeline-db-e2e/s07-compose-smoke-pipeline-db.md) | no | no | AC-PIPE-07, AC-PIPE-08 | BACK IMPLEMENT | completed |
| **s08** | [s08-docs-matrix-markers.md](s08-docs-matrix-markers.md)<br>• `pyproject.toml` testpaths/markers<br>• README matrix | [s08](../../implement/implement-v1-p1-pipeline-db-e2e/s08-docs-matrix-markers.md) | no | no | AC-PIPE-09, AC-PIPE-10 | BACK IMPLEMENT | completed |
...
## Summary-чеклист
- [x] s01 — WriterService.start_tcp
- [x] s02 — Timescale testcontainer + alembic fixture
- [x] s03 — L0 IPC → samples/events
- [x] s04 — L1 MQTT → samples
- [x] s05 — L1 MQTT lifecycle → events
- [x] s06 — L1 Modbus → samples
- [x] s07 — compose smoke script
- [x] s08 — docs matrix + markers

## Handoff
- **Next:** BACK REFLECT v1-p1-pipeline-db-e2e после Epic QA PASS
- **load_now:** `memory-bank/back/qa/v1-p1-pipeline-db-e2e/qa-20260730-v1-p1-pipeline-db-e2e.md`
- **Epic QA:** BACK QA v1-p1-pipeline-db-e2e — PASS
- **CREATIVE:** нет; все s01–s08 completed.
