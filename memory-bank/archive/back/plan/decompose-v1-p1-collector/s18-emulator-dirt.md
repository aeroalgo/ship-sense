...
- **Creative:** [CR-COL-03 / creative-collector-emulator-fidelity.md](../../creative/v1-p1-collector/creative-collector-emulator-fidelity.md) — ScenarioRunner отделяет value/metadata/transport dirt; порядок применения: base model → value overlays → timestamp/quality overlays → transport hooks.
