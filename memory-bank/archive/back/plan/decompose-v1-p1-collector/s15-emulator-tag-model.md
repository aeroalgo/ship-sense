...
- **Creative:** [CR-COL-03 / creative-collector-emulator-fidelity.md](../../creative/v1-p1-collector/creative-collector-emulator-fidelity.md) — универсальная profile-driven архитектура, общий snapshot, generic dependency graph и stable per-signal seed streams.
