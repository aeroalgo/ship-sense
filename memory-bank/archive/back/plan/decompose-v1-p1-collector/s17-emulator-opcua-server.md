...
- **Creative:** [CR-COL-03 / creative-collector-emulator-fidelity.md](../../creative/v1-p1-collector/creative-collector-emulator-fidelity.md) — adapter публикует общий profile-driven snapshot и NodeIds из профиля; сервер остаётся read-only.
