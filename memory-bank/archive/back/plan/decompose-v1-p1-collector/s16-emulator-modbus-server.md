...
- **Creative:** [CR-COL-03 / creative-collector-emulator-fidelity.md](../../creative/v1-p1-collector/creative-collector-emulator-fidelity.md) — adapter использует общий profile-driven snapshot `TagGenerator`; сервер остаётся read-only.
